 ...
 -->
          ...
          <div style="float:left">
            ...
            <div class="form-group">
              ...
              <textarea id="rich TextBody"  name="blog_short_description" required><?php echo e($blog_info->blog_short_description); ?></textarea>

            </div>

             <div class="form-group">
              <label class="loginformelement" for="blogdescription" >Blog Long Description</label>
              <textarea id="rich TextBody1" name="blog_long_description" required><?php echo e($blog_info->blog_long_description); ?></textarea>
...
<?php /* G:\xampp\htdocs\taznin_blog\taznin_blog\resources\views/admin/page/edit_blog.blade.php */ ?>