...
<head>
    ...
    <link href="<?php echo e(asset('public/frontend_resource/templatemo_style.css')); ?>" rel="stylesheet" type="text/css" />
    <!--  Designed by w w w . t e m p l a t e m o . c o m  -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/frontend_resource/tabcontent.css')); ?>" />
    <script type="text/javascript" src="<?php echo e(asset('public/frontend_resource/tabcontent.js')); ?>">
/***********************************************
    ...
    <div id="templatemo_header_panel">
        ...
        <div id="templatemo_content_container">
                    ...
                    <div class="templatemo_right_section">
                        ...
                        <div class="tabcontent_section">
                            ...
                            <div id="category" class="tabcontent">
                                ...
                                ?>
                                <ul>
                                    <?php $__currentLoopData = $all_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a href="<?php echo e(URL::to('/category-blog/'.$vCategory->category_id)); ?>"><?php echo e($vCategory->category_name); ?></a></li>
            ...
            <div class="templatemo_right_section">
                ...
                ?>
                <ul>
                    <?php $__currentLoopData = $popular_blog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v_blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><a href="<?php echo e(URL::to('/blog-details/'.$v_blog->blog_id)); ?>"><?php echo e($v_blog->blog_title); ?></a>(<?php echo e($v_blog->hit_counter); ?>)</li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>    
            </div>
            ...
            <div class="templatemo_right_section">
                ...
                ?>
                <ul>
                    <?php $__currentLoopData = $recent_blog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v_blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><a href="<?php echo e(URL::to('/blog-details/'.$v_blog->blog_id)); ?>"><?php echo e($v_blog->blog_title); ?></a></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /* G:\xampp\htdocs\taznin_blog\taznin_blog\resources\views/home.blade.php */ ?>