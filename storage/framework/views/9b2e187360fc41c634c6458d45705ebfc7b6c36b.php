...
<body class="lock">
    <div class="lock-header">
        ...
        <a class="center" id="logo" href="index.html">
            <img class="center" alt="logo" src="<?php echo e(asset('public/admin_asset/img/logo.png')); ?>">
        </a>
        <!-- END LOGO -->
    </div>
    <div class="login-wrap">
        ...
        <form action="<?php echo e(URL::to('/admin-login')); ?>" method="post" accept-charset="utf-8">
            <?php echo csrf_field(); ?>
...
<?php /* G:\xampp\htdocs\taznin_blog\taznin_blog\resources\views/admin/admin_login.blade.php */ ?>