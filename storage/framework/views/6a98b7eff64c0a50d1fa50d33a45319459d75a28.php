        ...
        <div class="container">
          ...
          <div style="float:left">
            ...
            <div class="form-group">
              ...
              <textarea  name="blog_short_description" required></textarea>
            </div>

             <div class="form-group">
              <label class="loginformelement" for="categorydescription" >Long Description</label>
              <textarea  name="blog_long_description" required></textarea>
            </div>
...
<?php /* C:\xampp\htdocs\taznin_blog\taznin_blog\resources\views/admin/page/add_blog.blade.php */ ?>